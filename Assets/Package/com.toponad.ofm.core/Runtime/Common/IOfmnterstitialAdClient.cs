...
{
    public interface IOfmInterstitialAdClient 
    {
		/***
		 * 请求广告  
		 ...
		 */
        void loadInterstitialAd(string placementId, string mapJson, string customRulesJson);
		/***
		 * 
		 * 设置监听回调接口
		 * 
		 * @param listener  
		 */
        void setListener(OfmInterstitialAdListener listener);
        /**
		 * 是否存在可以展示的广告
		 * @param unityid
		 */
