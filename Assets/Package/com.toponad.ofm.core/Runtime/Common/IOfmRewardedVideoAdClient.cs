...
{
    public interface IOfmRewardedVideoAdClient
    {
		/**
		 * 请求视屏广告
		 ...
		 */
        void loadVideoAd(string placementId, string mapJson, string customRulesJson);
		/**
		 * @param listener 监听回调
		 */ 
        void setListener(OfmRewardedVideoListener listener);
		/**
		 * 是否存在可以展示的广告
		 * @param unityid
		 * 
