...
{
    public interface IOfmBannerAdClient 
    {
		/***
		 * 请求广告  
		 ...
		 */
        void loadBannerAd(string placementId, string mapJson, string customRulesJson);
        /**
		 ...
		 * @param listener  
		 */
        void setListener(OfmBannerAdListener listener);
        /***
         * 
         * 展示广告,
         * @param placementId 
		 ...
		 */
        void showBannerAd(string placementId, OfmRect rect);
		/***
		 * 
		 * 清理广告
		 * @param placementId 
