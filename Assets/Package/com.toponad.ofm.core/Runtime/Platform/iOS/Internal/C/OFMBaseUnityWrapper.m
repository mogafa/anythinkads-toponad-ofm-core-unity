...
@end
@implementation OFMBaseUnityWrapper
...
-(instancetype) init {
    ...
    if (self != nil) {
        ...
        _callbackAccessQueue = dispatch_queue_create("com.ofmSDK.UnityPackage", DISPATCH_QUEUE_CONCURRENT);
    }
    return self;
}

-(void) setCallBack:(void (*)(const char *, const char *))callback forKey:(NSString *)key {
    __weak OFMBaseUnityWrapper* weakSelf = self;
